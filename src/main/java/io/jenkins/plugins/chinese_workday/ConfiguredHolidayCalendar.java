...
public class ConfiguredHolidayCalendar {
    ...
    static void validateDateList(String rawValue, String fieldName) {
        parseDateList(rawValue, fieldName);
    }

    static void validateCalendarEntry(String year, String holidays, String makeUpWorkdays) {
    ...
    static String normalizeDateList(String value) {
        String trimmedValue = Util.fixEmptyAndTrim(value);
        if (trimmedValue == null) {
            return "";
        }
